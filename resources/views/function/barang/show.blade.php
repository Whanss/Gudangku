            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-6">
                            <strong>Tanggal Masuk:</strong> {{ \Carbon\Carbon::parse($barang->tanggal_masuk)->format('d-m-Y') }}
                        </div>
                    </div>
                    <div class="row mt-3">
                        <div class="col-md-12">
                            ...
                            @if($barang->gambar)
                                <div class="mt-2">
                                    <img src="{{ asset('storage/' . $barang->gambar) }}" alt="Gambar Barang" style="max-width: 100%; height: auto;">
                                </div>
                            @else
